  ...
  <div class="box-info" hidden>
    ...
    <form class="form-horizontal">
      <div class="box-body">
        ...
        <div style>
          <div class="form-group">
            <label class="col-sm-3 control-label">使用反馈</label>
            <div class="col-sm-9 custom-control">
              <textarea style="margin-left:0px;" class="col-sm-12 form-control " rows="3"></textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <label class ="col-sm-3 control-label">
              <input id ="task_finish" type="checkbox" class="flat-red" checked>
            </label>
            <span class="col-sm-7 custom-control">已解决问题</span>
          </div>
        </div>
      </div>
      <!-- /.box-body -->
...
export default {
  ...
  updated: function () {
    console.log('checkRequirementInfo......updated')
  },
  mounted: function () {
    console.log('requirementInfoDlg......mounted')
